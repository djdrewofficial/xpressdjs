...
export const translated = new Set<string>([
  ...
  '/wedding-blog/dancing-on-the-clouds-first-dance-south-florida',
]);
...
type NavDict = {
  ...
  djDrew: string; djAtomic: string; djPhil: string; djReRe: string; djNaqeeb: string; allDjs: string;
  allServices: string; avRentals: string; photoBooths: string; glamBooth: string; photoTemplates: string; contentCreator: string; vibo: string;
...
type FootDict = {
  ...
  servicesHead: string; weddingDjs: string; avRentals: string; photoBooths: string; epicExtras: string;
...
export const ui: Record<Locale, { nav: NavDict; foot: FootDict; toggle: string }> = {
  en: {
    nav: {
      ...
      djDrew: 'Drew Segura', djAtomic: 'DJ Atomic', djPhil: 'DJ Phil', djReRe: 'DJ ReRe', djNaqeeb: 'DJ Naqeeb', allDjs: 'All DJs →',
      allServices: 'All Services', avRentals: 'A/V Rentals', photoBooths: 'Photo Booths', glamBooth: 'Glam Booth', photoTemplates: 'Photo Booth Templates', contentCreator: 'Content Creator', vibo: 'Vibo Planning App',
    ...
    foot: {
      ...
      servicesHead: 'Services', weddingDjs: 'Wedding DJs', avRentals: 'A/V Rentals', photoBooths: 'Photo Booths', epicExtras: 'Epic Extras',
  ...
  es: {
    nav: {
      ...
      djDrew: 'Drew Segura', djAtomic: 'DJ Atomic', djPhil: 'DJ Phil', djReRe: 'DJ ReRe', djNaqeeb: 'DJ Naqeeb', allDjs: 'Todos los DJs →',
      allServices: 'Todos los Servicios', avRentals: 'Renta de Audio y Video', photoBooths: 'Cabinas de Fotos', glamBooth: 'Glam Booth', photoTemplates: 'Plantillas de Cabina', contentCreator: 'Creador de Contenido', vibo: 'App de Planeación Vibo',
    ...
    foot: {
      ...
      servicesHead: 'Servicios', weddingDjs: 'DJs de Bodas', avRentals: 'Renta de Audio y Video', photoBooths: 'Cabinas de Fotos', epicExtras: 'Extras Épicos',
